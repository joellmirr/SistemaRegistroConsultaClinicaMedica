...
public class ConsultarFuncionario extends javax.swing.JInternalFrame {
    FuncionarioDao PFdao = new FuncionarioDao() {};
    /**
    ...
    private void initComponents() {
        ...
        jButton_BuscaCompleta_.setText("Busca Todos Funcionarios");
    ...
    public void Atualizar(){
        ...
        pf.setIdpessoafisica(jTable_Funcionario.getModel().getValueAt(i,0).toString());
        pf.setCpf(jTable_Funcionario.getModel().getValueAt(i,1).toString());
        pf.setSenha(jTable_Funcionario.getModel().getValueAt(i,2).toString());
        pf.setNome(jTable_Funcionario.getModel().getValueAt(i,3).toString());
        pf.setEmail(jTable_Funcionario.getModel().getValueAt(i,4).toString());
        pf.setTelefone(jTable_Funcionario.getModel().getValueAt(i,5).toString());
        pf.setEndereco(jTable_Funcionario.getModel().getValueAt(i,6).toString());
