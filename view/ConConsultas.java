 ...
 * @author joelmir
 */
public class ConConsultas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Consulta Consultas Medicas");
        ...
        jButton_BuscaCompleta_.setText("Busca Todos Consultas");
        ...
        jScrollPane1.setViewportView(jTable_Consultas);
    ...
    private void jButton_Buscar_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Buscar_ActionPerformed
        String sqlcpfM = "SELECT * FROM Consultas WHERE dataconsulta = ?";
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Consultas.getModel();
    ...
    public void BuscarTab(String sql){
        ...
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Consultas.getModel();
           ...
           // Conectar ao banco de dados e obter dados da tabela
            String SQL = JOptionPane.showInputDialog("Digite Date da Consulta:");
            try {
                //JOptionPane.showMessageDialog(null,sql);
                PreparedStatement ps = conn.getConexao().prepareStatement(sql);
                ps.setString(1, SQL);
    ...
    public void Atualizar(){
        int i = jTable_Consultas.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        ConsultaM c = new ConsultaM();
        c.setIdconsulta(jTable_Consultas.getModel().getValueAt(i,0).toString());
        c.setPaciente((int) jTable_Consultas.getModel().getValueAt(i,1));
        c.setDataconsulta(jTable_Consultas.getModel().getValueAt(i,2).toString());
        c.setValorconsulta((float) jTable_Consultas.getModel().getValueAt(i,3));
        c.setMotivoconsulta(jTable_Consultas.getModel().getValueAt(i,4).toString());
        c.setNomeexame(jTable_Consultas.getModel().getValueAt(i,5).toString());
        c.setDescricaoexame(jTable_Consultas.getModel().getValueAt(i,6).toString());
        c.setMedico((int) jTable_Consultas.getModel().getValueAt(i,7)); 
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Consultas.getValueAt(i, 0);
