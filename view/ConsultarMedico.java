...
public class ConsultarMedico extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable_Medico = new javax.swing.JTable();
        jButton_LimparTabela_ = new javax.swing.JButton();

        setClosable(true);
        setMaximizable(true);
        setResizable(true);
        setTitle("Consulta Medico");
        ...
        jButton_BuscaCompleta_.setActionCommand("Busca Todos Medicos");
        ...
        jTable_Medico.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTable_Medico);
    ...
    private void jButton_Buscar_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Buscar_ActionPerformed
        String sqlcpfM = "SELECT * FROM Medico WHERE cpf = ?";
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Medico.getModel();
    ...
    public void Atualizar(){
        int i = jTable_Medico.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        MedicoM m = new MedicoM();
        m.setIdmedico((int) jTable_Medico.getModel().getValueAt(i,0));
        m.setNome(jTable_Medico.getModel().getValueAt(i,1).toString());
        m.setCpf(jTable_Medico.getModel().getValueAt(i,2).toString());
        m.setCrm(jTable_Medico.getModel().getValueAt(i,3).toString());
        m.setEspecialidade(jTable_Medico.getModel().getValueAt(i,4).toString());
        m.setEmail(jTable_Medico.getModel().getValueAt(i,5).toString());
        m.setTelefone(jTable_Medico.getModel().getValueAt(i,6).toString());
        m.setEndereco(jTable_Medico.getModel().getValueAt(i,7).toString());
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Medico.getValueAt(i, 0);
        Mdao.excluir(o);
    ...
    private javax.swing.JTable jTable_Medico;
