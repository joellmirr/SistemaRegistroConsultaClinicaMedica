...
public class ConsultarPaciente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton_BuscaCompleta_.setText("Busca Todos Pacientes");
    ...
    private void jButton_Buscar_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Buscar_ActionPerformed
        String sqlcpfM = "SELECT * FROM Paciente WHERE cpf = ?";
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Paciente.getModel();
    ...
    public void Atualizar(){
        int i = jTable_Paciente.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        PessoaFisica p = new PessoaFisica();
        p.setIdpessoafisica(jTable_Paciente.getModel().getValueAt(i,0).toString());
        p.setNome(jTable_Paciente.getModel().getValueAt(i,1).toString());
        p.setCpf(jTable_Paciente.getModel().getValueAt(i,2).toString());
        p.setEmail(jTable_Paciente.getModel().getValueAt(i,3).toString());
        p.setTelefone(jTable_Paciente.getModel().getValueAt(i,4).toString());
        p.setEndereco(jTable_Paciente.getModel().getValueAt(i,5).toString());
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Paciente.getValueAt(i, 0);
        Pdao.excluir(o);
